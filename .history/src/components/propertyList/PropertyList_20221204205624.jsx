...
const PropertyList = () => {
	return (
		<div className="pList">
			...
			<div className="pListItem">
				<img
					src="https://images.unsplash.com/photo-1488085061387-422e29b40080?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1631&q=80"
					alt=""
					className="pListImg"
				/>
				<div className="pListTitles">
			...
			<div className="pListItem">
				<img
					src="https://images.unsplash.com/photo-1669853885724-fe95e3e8dcb4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1948&q=80"
					alt=""
					className="pListImg"
				/>
				<div className="pListTitles">
